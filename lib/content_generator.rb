...
module ContentGenerator
  ...
  module Postgres
    ...
    def self.size(flavor, location, family, size)
      ...
      unit_price = BillingRate.from_resource_properties("PostgresVCpu", "#{family}-#{flavor}", location)["unit_price"].to_f
    ...
    def self.ha_type(flavor, location, family, vm_size, storage_size, ha_type)
      ...
      compute_unit_price = BillingRate.from_resource_properties("PostgresVCpu", "#{family}-#{flavor}", location)["unit_price"].to_f
