...
module Option
  ...
  VmSizes = [2, 4, 8, 16, 30, 60].map {
    ...
    storage_size_options = [_1 * 20, _1 * 40]
    VmSize.new("basic-#{_1}", "basic", 2, _1, _1 * 100, 0, _1 * 2, storage_size_options, false, false, "x64")
  }).concat([1, 2].map {
    storage_size_options = [_1 * 20, _1 * 40]
    VmSize.new("basic-#{_1}", "basic", 4, _1, _1 * 100, 0, (_1 * 1.6).to_i, storage_size_options, false, false, "arm64")
  }).freeze
