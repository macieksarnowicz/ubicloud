...
module Option
  ...
  VmSizes = [2, 4, 8, 16, 30, 60].map {
    ...
    VmSize.new("burstable-#{_1[0]}x#{_1[1] * 4 / 100}", "burstable", _1[0] / 2, _1[0], _1[1], _1[1], _1[1] * 4 / 100, storage_size_options, false, false, "x64")
  }).concat([[2, 50], [2, 100]].map {
    storage_size_options = [_1[1] * 20 / 100, _1[1] * 40 / 100]
    VmSize.new("burstable-#{_1[0]}x#{_1[1] * 4 / 100}", "burstable", _1[0], _1[0], _1[1], _1[1], (_1[1] * 3.2 / 100).to_i, storage_size_options, false, false, "arm64")
  }).concat([[2, 100], [2, 200]].map {
    storage_size_options = [_1[1] * 10 / 100, _1[1] * 20 / 100]
    VmSize.new("basic-#{_1[0]}x#{_1[1] / 100}", "basic", _1[0], _1[0], _1[1], 0, _1[1] / 100, storage_size_options, false, false, "x64")
  }).concat([[2, 100], [2, 200]].map {
    storage_size_options = [_1[1] * 10 / 100, _1[1] * 20 / 100]
    VmSize.new("basic-#{_1[0]}x#{_1[1] / 100}", "basic", _1[0] * 2, _1[0], _1[1], 0, (_1[1] * 0.8 / 100).to_i, storage_size_options, false, false, "arm64")
  }).freeze
